...
<head>
  ...
  <script src="http://maps.googleapis.com/maps/api/js?key=AIzaSyDVZxervTdilci_cAg0qjntWtoo3LIZpxI&v=weekly"></script>
...
<script>
var map, info_window, marker;

init = function() {
  // menentukan opsi peta
  var options = {
    center: new google.maps.LatLng(0.45966, 101.410347), // menentikan latitude dan longitude
  ...
  for (var i = 0; i < lokasi.length; i++) {
    var position = new google.maps.LatLng(lokasi[i][1], lokasi[i][2]);
...
<script type="text/javascript" src="js/cari-peta.js"></script>
